    ...
    <aside class="lg:col-span-5 h-full scrollbar-hide relative flex gap-4 flex-col overflow-hidden overflow-y-scroll">
        ...
        <main>
            ...
            <section class="flex flex-col gap-2">
                 ...
                 <!-- main comment-->
                <div class="flex items-center ml-auto gap-3 py-2">
                    <x-avatar story src="https://source.unsplash.com/500x500?face-{{rand(1,10)}}" class="h-9 w-9 mb-auto" />
                ...
                <div class="flex items-center gap-3 w-11/12 ml-auto py-2">
                    <x-avatar story src="https://source.unsplash.com/500x500?face-{{rand(1,10)}}" class="h-8 w-8 mb-auto" />
