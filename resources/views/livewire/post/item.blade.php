<div class="max-w-lg mx-auto">
    ...
    <footer>
        ...
        <form wire:key='{{ time() }}'
                                        @submit.prevent="$wire.addComment()" x-data="{ body: @entangle('body') }"
                                        class="grid grid-cols-12 items-center w-full">
                                        @csrf


                                        <input x-model="body" type="text" placeholder="leave a comment"
                                            class=" col-span-10 placeholder:text-sm  outline-none  focus:outline-none border-none px-2 rounded-lg hover:ring-0 focus:ring-1">

                                        <div class="col-span-1 ml-auto flex justify-end text-right">
                                            <button type="submit" x-cloa x-show="body.length >0"
