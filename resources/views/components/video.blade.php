...
>
        ...
        <video controls x-ref="player" @play="playing=true" @pause="playing=false" class=" h-full max-h-[500px] w-full">
            <source src="{{$source}}" type="video/mp4">
            Your browser does not support htsml video
        </video>

        {{--- play ---}}

        <div x-cloak x-show="!playing" @click="$refs.player.play" class="absolute z-10 insert-0 flex items-center justify-center w-full h-full cursor-pointer">
        ...
        <div x-show="playing" @click="$refs.player.pause" class="absolute z-10 insert-0 flex items-center justify-center w-full h-full cursor-pointer">
